...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thanh Tâm - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0836619968</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thanh Tâm - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0836619968</div>", unsafe_allow_html=True)
